...
Ý tưởng cốt lõi của KNN là: *Một đối tượng sẽ được phân loại dựa trên "những người hàng xóm" gần nhất của nó*.
...
*Minh họa: Với K=3, điểm dữ liệu mới (sao) được phân loại là tam giác. Với K=5, nó được phân loại là hình vuông.*
